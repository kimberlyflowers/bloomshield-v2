      ...
      <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl relative">
        ...
        {currentView === 'signup' && (
          <div>
            ...
            <p className="text-gray-600 mb-8 text-center">Join BloomShield to protect your creative work</p>
            ...
            <div className="flex flex-col gap-3 mb-6">
              <button
                ...
                disabled={loading}
                className="w-full bg-white border-2 border-gray-300 text-gray-700 py-3 rounded-lg font-semibold hover:bg-gray-50 transition-all disabled:opacity-50 flex items-center justify-center gap-3"
              >
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-[#1877F2] text-white py-3 rounded-lg font-semibold hover:bg-[#166FE5] transition-all disabled:opacity-50 flex items-center justify-center gap-3"
              >
            ...
            <form onSubmit={handleSignUp}>
              ...
              <div className="mb-6">
                <label className="flex items-start cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 mr-2 mt-0.5 cursor-pointer accent-[#FF8C42]"
                    disabled={loading}
                  />
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#FF8C42] text-white py-3 rounded-lg font-semibold hover:bg-[#ff7a2e] transition-all disabled:bg-gray-300 disabled:cursor-not-allowed mb-4"
              >
        ...
        {currentView === 'login' && (
          <div>
            <h2 className="text-3xl font-bold text-gray-800 mb-2 text-center">Welcome to BloomShield</h2>
            <p className="text-gray-600 mb-8 text-center">Sign in to protect your creative work</p>
